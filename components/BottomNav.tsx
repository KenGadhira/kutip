...
export default function BottomNav({
  ...
  return (
    <nav
      className={`w-full bg-[#f9f8f6] border-t border-[#f3f4f6] flex items-center justify-between px-[24px] pt-[14px] pb-[calc(14px+env(safe-area-inset-bottom,0px))] shrink-0 fixed z-50 sticky bottom-0 ${className}`}
